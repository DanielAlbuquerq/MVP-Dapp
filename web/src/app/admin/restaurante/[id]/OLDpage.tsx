...
export default function RestaurantMenu({ params }: { params: Promise<{ id: string }> | { id: string } }) {
  ...
  return (
    <main className="pl-5 text-gray-900 relative">
      {/* Page Header  */}
      <div className="w-full mx-auto">
        <div>
            <img src={restaurantLogoUrl ? restaurantLogoUrl : "restaurantLogoUrl"} alt={"Sua Logo aqui"} className="w-20 h-20 object-cover rounded-md" />
        <h1></h1>
